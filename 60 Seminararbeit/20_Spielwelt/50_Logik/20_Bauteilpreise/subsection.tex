...
\begin{figure}[ht]
     ...
     \begin{tikzpicture}[x=5cm,y=5cm]
          ...
          \path [draw,name path=angebot][fn] (0.1,0.1) -- (0.9,0.9) node[right] {$Angebot$}; \path [draw,name path=nachfrage][fn] (0.9,0.1) -- (0.1,0.9) node[above,xshift=18] {$Nachfrage$}; \path [draw,name path=nachfrage',xshift=0.5cm,n'][fn] (0.1,0.9) -- (0.9,0.1) node[right] {$Nachfrage'$};
